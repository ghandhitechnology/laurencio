...
- `packages/server/src/auth.ts`: Better Auth with the device authorization plugin and GitHub OAuth. Session for the web approval page; device tokens for the CLI, one per device, revocable.
